...
public class PeriodController {
	...
	public ResponseEntity<CompletePeriodResponse> getMissingPeriods() {
		...
		try {
			...
			completePeriodResponse.setStatus(AppUtils.getExceptionStatus(AppConstants.ERROR, e));
			return new ResponseEntity<CompletePeriodResponse>(completePeriodResponse, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
